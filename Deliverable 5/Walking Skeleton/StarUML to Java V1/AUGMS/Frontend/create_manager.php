...
try {
    ...
    if ($column) {
        // Check if it's an ENUM and if Manager is missing
...
// Get all managers
$stmt = $pdo->query("SELECT * FROM Users WHERE user_type = 'Manager' ORDER BY created_at DESC");
...
<body>
    <div class="container">
        ...
        <?php if ($success): ?>
            <div class="alert alert-success">
                ...
                <?php if ($created_user): ?>
                    ...
                    <br>
                    <a href="index.php" style="color: #2a9d8f; text-decoration: underline;">Click here to log in</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= date('M d, Y', strtotime($mgr['created_at'])) ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
            <a href="index.php" style="color: #2a9d8f;">← Back to Login</a> | 
            <a href="register.php" style="color: #2a9d8f;">Go to Registration</a>
        </div>
    </div>
</body>
</html>
